...
public class GridManager
{
    ...
    #region Neighbor
    public List<GridCell> GetNeighborSameColorBalls(string scr, int x, int y)
    {
        List<GridCell> list = new List<GridCell>();
        List<GridCell> neightbors = GetNeighborCells(x, y);
        foreach (GridCell cell in neightbors)
        {
            if (IsOccupiedBall(cell.X, cell.Y) && cell.Ball.number.text == scr)
            {
                list.Add(cell);
            }
        }
    ...
    public List<GridCell> GetListNeighborsSameColorRecursive(Ball bullet)
    {
        ...
        List<GridCell> neighbors = GetNeighborSameColorBalls(bullet.number.text,
        ...
        do
        {
            ...
            {
                List<GridCell> list = GetNeighborSameColorBalls(mainCell.Ball.number.text, cell.X, cell.Y);
